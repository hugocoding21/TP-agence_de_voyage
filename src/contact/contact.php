...
<body>
  ...
  <div class="page">
    ...
    <div class="bloc2">
      <form method="POST" action="../verifier_contact/verifier_contact.php" class="form">
        <div class="form1">
          <label for="|">
            Firstname : <br />
          ...
          <label>
            Nearest agency : <br />
            <input type="text" name="agency" id="" required />
          </label>
        </div>
        ...
        <div class="blockmsg">
          <label for="msg">
            Message : <br />
            <input id="msg" type="text" name="message" id="" required />
          </label>
        </div>
        <div class="btn2">
          <button id="button2" type="submit" name="submit">Send</button>
        </div>
      </form>
